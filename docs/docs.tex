...
To end the current session in \texttt{UML2Java}, press \texttt{File $\rightarrow$ Exit} and UML2Java will terminate 
\begin{figure}[H] \begin{center} 
...
\end{figure}
\newpage
\subsection{Resizing a Class}\index{Editing!Resizing the Classes}
...
\begin{figure}[H]
\begin{center}
\subfloat[Click and hold the corner of a class] {\label{fig:editMoveClass1}\fbox{\includegraphics[trim = 0pt 0pt 0pt 0pt, clip, scale=0.6]{./images/edit-resizeClass1.png}}} \imagespace
\subfloat[Release at desired location] {\label{fig:editMoveClass2}\fbox{\includegraphics[trim = 0pt 0pt 0pt 0pt, clip, scale=0.6]{./images/edit-resizeClass2.png}}}
...
\subsubsection{Removing Relationship Points}\index{Editing!Relationships!Removing Relationship Points}
...
\begin{figure}[H]
\begin{center}
\subfloat[Removing a point] {\label{fig:changeRelationTyped}\fbox{\includegraphics[scale=0.55]{./images/edit-relationshippoint4.png}}} \imagespace
\subfloat[The new line] {\label{fig:changeRelationTyped}\fbox{\includegraphics[scale=0.55]{./images/edit-relationshippoint3.png}}}
\vspace{-5pt}
